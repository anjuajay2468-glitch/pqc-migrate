...
echo "============================================="
echo "   PQC-Migrate Hybrid TLS Resource Test"
echo "============================================="
echo
echo "Configuration: X25519 + ML-KEM-768"
echo "TLS group: X25519MLKEM768"
...
if [ "$success" -eq 0 ]; then
    ...
    echo "Make sure tls_hybrid_server.sh is running on port 4435."
    exit 1
fi
