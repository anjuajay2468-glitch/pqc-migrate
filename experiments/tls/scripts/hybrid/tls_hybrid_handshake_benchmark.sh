...
echo "============================================="
echo "   PQC-Migrate Hybrid TLS 1.3 Benchmark"
echo "============================================="
echo
echo "OpenSSL:"
"$OPENSSL" version
...
if [ "$success" -eq 0 ]; then
    echo
    echo "ERROR: No successful hybrid TLS handshakes."
    echo "Verify that tls_hybrid_server.sh is running."
    exit 1
fi
...
echo
echo "TLS 1.3 hybrid handshake checks: SUCCESS"
