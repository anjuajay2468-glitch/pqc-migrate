...
echo "============================================="
echo "   PQC-Migrate Classical SSH Resource Test"
echo "============================================="
echo
...
if [ "$success" -eq 0 ]; then
    echo
    echo "ERROR: No successful SSH resource measurements."
...
cat > "$PROJECT_ROOT/experiments/ssh/results/classical_ssh_resource.csv" <<CSV
algorithm,category,operation,kex,iterations,successful,average_elapsed_s,average_user_cpu_s,average_system_cpu_s,max_rss_kb
X25519,CLASSICAL,connection,$KEX,$ITERATIONS,$success,$average_elapsed,$average_user,$average_sys,$maximum_rss
CSV
